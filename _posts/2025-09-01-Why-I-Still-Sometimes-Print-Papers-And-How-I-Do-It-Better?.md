...
I would also do this for Image-Based PDFs if I wanted to do things fast and move along. Below, I want to present the approach that works better for Image-Based PDFs which uses [Scantailor](https://scantailor.org/).
...
`pdfcrop` works on digital PDFs where things are trivial - you estimate the interest region by looking at the PDF's TextBox. On the other hand, I encourage you to look at those PDFs "artifacts" in the best free PDF-edition software on the market - [LibreOffice Draw](https://www.libreoffice.org/discover/draw/).
